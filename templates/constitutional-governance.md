...
1. Copy this file to `.github/copilot-instructions.md` (or a dedicated section within it)
...
- [ ] File saved to `.github/copilot-instructions.md` (or as a linked reference file)
